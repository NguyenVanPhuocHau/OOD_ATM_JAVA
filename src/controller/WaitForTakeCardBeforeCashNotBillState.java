...
public class WaitForTakeCardBeforeCashNotBillState extends AtmState{

	public WaitForTakeCardBeforeCashNotBillState(AtmMachine atm) {
		super(atm);
	...
	public void clickCardButton() {
		...
		atm.getConnect().setAtmState(new WaitForTakeCashState(atm));
