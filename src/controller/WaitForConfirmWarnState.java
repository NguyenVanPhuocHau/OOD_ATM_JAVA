...
public class WaitForConfirmWarnState extends AtmState{

	public WaitForConfirmWarnState(AtmMachine atm) {
		super(atm);
	...
	public void clickRight4Button() {
		...
		atm.getConnect().setAtmState(new WaitForEnterPinState(atm));
