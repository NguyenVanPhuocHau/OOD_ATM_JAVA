...
public class WaitForChooseLanguageState extends AtmState{

	public WaitForChooseLanguageState(AtmMachine atm) {
		super(atm);
	...
	public void clickRight3Button() {
		atm.getScreen().NoteDisplay();
		atm.getConnect().setAtmState(new WaitForConfirmWarnState(atm));
